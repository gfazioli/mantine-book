...
<Table withTableBorder withColumnBorders my="md">
  ...
  <Table.Tbody>
    <Table.Tr>
      ...
      <Table.Td>Turn the current page forward</Table.Td>
    </Table.Tr>
    <Table.Tr>
      <Table.Td>
        <Kbd>←</Kbd>
      </Table.Td>
      <Table.Td>Turn the previous page back</Table.Td>
    </Table.Tr>
    <Table.Tr>
      <Table.Td>
        <Kbd>Home</Kbd>
      </Table.Td>
      <Table.Td>Jump to the front cover (closed book)</Table.Td>
    </Table.Tr>
    <Table.Tr>
      <Table.Td>
        <Kbd>End</Kbd>
      </Table.Td>
      <Table.Td>Jump past the last page (back cover)</Table.Td>
    </Table.Tr>
  </Table.Tbody>
</Table>
...
`Book` supports the full Mantine [Styles API](https://mantine.dev/styles/styles-api/).
