...
`aria-roledescription="book"`, and a polite live region announces the
visible pages after every turn (Page X of N). Use `pageAnnouncement` to
localize or customize the message:
