...
function Demo() {
  return (
    <Book variant="rounded"{{props}} width={260} height={360}>
      <Book.Page>
        <Book.Page.Front>
...
function Demo({ curlRadius }: { curlRadius?: number }) {
  return (
    <Book variant="rounded" curlRadius={curlRadius} width={260} height={360}>
      <Book.Page>
        <Book.Page.Front>
          <Face label="Front A" color={FRONT_COLOR} />
        </Book.Page.Front>
